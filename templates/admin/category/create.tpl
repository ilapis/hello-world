...
<div class="col-md-6">
    <form id="inputs" class="row g-3 needs-validation" novalidate action="/admin/category/save" data-method="post"></form>
</div>

<script>
    document.addEventListener('DOMContentLoaded', function () {
        $("#inputs").ql_form(<?=json_encode(App\Form\Admin\CategoryPageForm::get());?>);
    }, false);
</script>
